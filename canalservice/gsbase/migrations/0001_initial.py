    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_usd', models.DecimalField(decimal_places=3, max_digits=12, verbose_name='Стоимость,$')),
                ('price_rub', models.DecimalField(decimal_places=3, max_digits=12, verbose_name='Стоимость в руб.')),
